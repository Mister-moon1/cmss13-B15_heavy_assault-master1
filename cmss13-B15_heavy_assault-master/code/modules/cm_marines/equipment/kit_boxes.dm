...
/obj/item/storage/box/kit/heavyassault
	name = "\improper B15 Heavy Assault Armor kit"
	pro_case_overlay = "engi"

/obj/item/storage/box/kit/heavyassault/fill_preset_inventory()
	new /obj/item/clothing/suit/storage/marine/heavyassault(src)
	new /obj/item/clothing/head/helmet/marine/heavyassault(src)
