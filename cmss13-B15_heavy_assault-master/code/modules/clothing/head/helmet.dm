...
/obj/item/clothing/head/helmet/marine/heavyassault
	name = "\improper B15 helmet"
	desc = "A robust hunk of metal and rubber designed to go with the B15 heavy assault armor. Looks strong enough to survive quite an attack."
